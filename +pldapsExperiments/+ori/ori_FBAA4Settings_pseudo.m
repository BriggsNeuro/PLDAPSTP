function s = ori_FBAA4Settings_pseudo
%%%%%%%%%%%%%%%%%
% training 2 - block
...
% s.pldaps.nosave = 1;
%set reward amounts
s.behavior.reward.amount = [0.05 0.08 0.08];
...
s.stimulus.runtype = 'pseudo'; %change to 'block' for block trials, 'pseudo' for pseudorandom
s.stimulus.midpointIR = 1; %use midpoint IR beam to turn off stimulus
s.stimulus.nrBlocks = 1000; %nr blocks for all conditions
s.stimulus.jitter  =1;
